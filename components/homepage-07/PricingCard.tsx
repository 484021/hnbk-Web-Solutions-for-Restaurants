...
const designPricingList = [
  { list: 'Domain + Hosting (1 year)', feature: true },
  { list: 'Custom website design', feature: true },
  { list: 'Restaurant-optimized features', feature: true },
  { list: 'Delivered in milestones', feature: true },
  { list: 'Basic support included', feature: true },
  { list: 'Menu upload & setup', feature: true },
  { list: 'SEO best practices setup', feature: true },
  { list: 'Google Business integration', feature: true },
]

const customPricingList = [
  { list: 'Website maintenance', feature: true },
  { list: 'Menu/content updates', feature: true },
  { list: 'Backups & security checks', feature: true },
  { list: 'Regular software updates', feature: true },
  { list: 'Priority restaurant support', feature: true },
  { list: 'Bug fixes and patches', feature: true },
  { list: 'Monthly performance reports', feature: true },
  { list: 'Ongoing SEO improvements', feature: true },
]

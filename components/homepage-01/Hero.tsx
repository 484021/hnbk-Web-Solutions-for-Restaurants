      ...
      <div className="container">
        <RevealWrapper className="text-center">
          ...
          <h1 className="mb-7 xl:mb-8">
            ...
            with Cutting-Edge
            <br />
            <i className="font-instrument italic">Web</i> Solutions
          </h1>
          <p className="mx-auto mb-10 max-w-xl md:mb-14 lg:max-w-[750px] xl:mb-[76px]">
            Bring your restaurant’s vision to life with hnbk Web Solutions. We fuse design, strategy, and technology to
            create powerful digital platforms that attract more customers, streamline operations, and grow your brand.
          </p>

          ...
          <div className="flex-1">
            ...
            <TextAppearAnimation>
              <h2 className="text-appear mt-3 md:mt-5">
                Success Stories in
                <span className="font-instrument italic"> Helping</span> Restaurants
              </h2>
            </TextAppearAnimation>
          </div>
          <div className="flex-1">
            <TextAppearAnimation>
              <p className="text-appear md:text-right">
                Discover how hnbk brings restaurants to life with impactful digital solutions. Our portfolio showcases
